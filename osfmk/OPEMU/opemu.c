/*                                                                  8888888 88888888  88888888
            ...
            888  888 888  888 88888888 888  888  888 888  888         888         88  88
            Y88..88P 888 d88P Y8b.     888  888  888 Y88b 888         888          8888
             "Y88P"  88888P"   "Y8888  888  888  888  "Y88888       8888888         88
                     888                                                                    
                     888                                                                    
                     888                                                                    
IM      ~ SINETEK                                                                           
 ...
 *  . AnV Added SSEPlus instructions
 */
#include <stdint.h>
#include <i386/trap.h>
...
int opemu_ktrap(x86_saved_state_t *state)
{
    ...
    const uint8_t *code_stream = (const uint8_t*) saved_state->eip;
#else /* __x86_64__ */
...
#ifdef __i386__
        printf ("[RDMSR] unknown location 0x%08lx\r\n", saved_state->ecx);
...
#ifdef __i386__
        printf ("[WRMSR] unknown location 0x%08lx\r\n", saved_state->ecx);
#else /* __x86_64__ */
...
#ifdef __i386__
    op_obj.state32 = saved_state;
    op_obj.state_flavor = SAVEDSTATE_32;
#else /* __x86_64__ */
