...
void pcmpistri(ssse3_t *this)
{
	...
	__int128_t *src = (__int128_t *)&(this->src.ui);
	__int128_t *dst = (__int128_t *)&(this->dst.ui);
...
void pcmpestrm(ssse3_t *this)
{
	...
	__int128_t *src = (__int128_t *)&(this->src.ui);
	__int128_t *dst = (__int128_t *)&(this->dst.ui);
    __int128_t *res = (__int128_t *)&(this->res.ui);
...
{
    this->res.s64[0] = this->src.s64[0] > this->dst.s64[0] ? 0xFFFFFFFFFFFFFFFFLL : 0;
    this->res.s64[1] = this->src.s64[1] > this->dst.s64[1] ? 0xFFFFFFFFFFFFFFFFLL : 0;
}
